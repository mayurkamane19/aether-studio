 ...
 * lead scoring, notes, activity timeline logging, AI sales intelligence, and AI pricing assistance for Aether Studio.
...
async function saveAIPricingAnalysis(leadId, pricingData) {
  ...
  // Mark prior active pricing records as SUPERSEDED
...
async function approveAIPricing(leadId, pricingId) {
  // Update status in lead_pricing_analysis
